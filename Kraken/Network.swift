...
public struct Network {
    ...
    public typealias AsyncOperation = (Result<[String : Any]>) -> ()
    ...
    func getRequest(with method:String, params: [String : String]? = [:], type: RequestType = .publicRequest, completion: @escaping AsyncOperation) {
        let params = params ?? [:]
    ...
    func postRequest(with path:String, params: [String : String]?, type: RequestType = .privateRequest, completion: @escaping AsyncOperation) {
    ...
    private func rawRequest(_ request: URLRequest, completion: @escaping AsyncOperation) {
        ...
        session.dataTask(with: request) { (data, response, error) in
            ...
            do{
                ...
                if let errorArray = json["error"] as? Array<String>  {
